    ...
    <div className="about_page">
          ...
          <div className="about_info">
            ...
            <div className="content">
              ...
              <p>I pride myself on being friendly, approachable, patient and eager to learn. If you are looking for a goal oriented strategist and experienced developer, contact me through the link below. <br></br><br></br>I look forward to working with <span className="you">YOU</span>.</p>
            </div>
          </div>
